...
for i = countyid
    ...
    lockdown_release_1 = datetime(2020,10,14); % this should stay fixed now since they've started lifting lockdown in FL
    ...
    soc_dist_end_date = datetime(2020, 10, 14);
    ...
    save(sprintf('%s_Scen2.mat',county));
