...
for i = countyid
    ...
    lockdown_release_1 = datetime(2020, 12, 31); % this should stay fixed now since they've started lifting lockdown in FL
    ...
    soc_dist_end_date = datetime(2020, 12, 31);
    ...
    quarantine_start_date = timeRef(end);
    ...
    save(sprintf('%s_Scen5.mat',county));
