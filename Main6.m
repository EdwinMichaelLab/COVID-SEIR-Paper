...
for i = countyid
    ...
    lockdown_release_1 = datetime(2022, 02, 31); % this should stay fixed now since they've started lifting lockdown in FL
    ...
    soc_dist_end_date = datetime(2022, 02, 31);
    ...
    save(sprintf('%s_Scen6.mat',county));
